...
class CustomizeRenderer(BaseRenderer):
    ...
    def __init__(self, screen):
        ...
        self.cols = [
            ...
            {'x': self.padding * 2 + cfg['COLUMN_1_WIDTH'], 'w': cfg['COLUMN_2_WIDTH'], 'title': ""}, # タイトルは動的
            {'x': self.padding * 3 + cfg['COLUMN_1_WIDTH'] + cfg['COLUMN_2_WIDTH'], 'w': cfg['COLUMN_3_WIDTH'], 'title': ""} # タイトルは動的
        ]
    ...
    def _draw_column_2(self, data):
        ...
        self.draw_text(f"{slots[data['slot_idx']][1]}一覧", (col['x'] + 10, list_y + 10), (150, 160, 180))
